...
PARAMS: dict[str, dict[str, Any]] = {
    "images": {
        "desc": (
            ...
            "  • create_image: a SINGLE 'post:<image_id>' (or bare image_id) "
            "is in-Grok img2img — imageToImage from that Grok image, NO "
            "re-upload (low moderation). Local files / multiple refs upload as "
            "refs; @N in prompt maps to images[N-1] (1-based). Empty/omitted = "
            "txt2img. 'ref:<id>' (saved Reference) is rejected — video-only.\n"
